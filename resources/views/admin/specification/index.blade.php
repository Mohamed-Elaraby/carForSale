...
@section('title', __('trans.all specifications list'))
        ...
        <div class="col-xs-12">
            <div class="card">
                ...
                <div class="card-header" style="margin: 20px 0">
                    <div class="row">
                        <div class="col-xs-9">
                            <h4 style="margin: 0; padding: 0; display: inline">{{__('trans.all specifications list')}}</h4>
                        </div>
                        <div class="col-xs-3">
{{--                            @if (Auth::user()->hasPermission('create-productCodes'))--}}
                                <a href="{{ route('admin.specifications.create') }}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> {{ __('trans.create') }}</a>
{{--                            @endif--}}
                        </div>
                    </div>
{{--                    <div class="row">--}}
