@php
    ...
    $pageItem = __('trans.specifications')
@endphp
    ...
    <div class="row">
        <div class="col-xs-6 center-block" style="float: none">
            <div class="card card-primary mt-5">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => ['admin.specifications.update', $specification -> id], 'method' => 'put']) !!}
                    <div class="form-group">
                        {!! Form::label('name', __('trans.specifications'), ['class' => 'control-label']) !!}
