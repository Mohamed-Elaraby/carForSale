...
class SpecificationDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($query){
                return view('admin.datatableHtmlBuilderRender.specification.action', compact('query'));
            })
            ->rawColumns(['action']);
    }
     ...
     */
    public function query(Specification $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('name')            -> title( __('trans.specification') ),
